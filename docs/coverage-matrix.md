...
| C8 | machine | — | unmapped | T16 | Every field populated on the first attempt; attempt number increments; no context API mutates the graph; data interval recorded verbatim (T16). |
