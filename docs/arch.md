...
**Post-M4 boundary amendments** — capability decisions that moved a *permanent* non-goal, each recorded in its own ADR and listed here so the spec's history is readable in one place:
