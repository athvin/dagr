...
- [ ] **107** · [T92 — rust-skills adoption register (decision)](107-T92-rust-skills-adoption-register.md) · S · decision
- [ ] **108** · [T93 — Cargo release/bench/dev profiles](108-T93-cargo-profiles.md) · S · setup — after T92
- [ ] **109** · [T94 — edition 2024 migration and MSRV bump](109-T94-edition-2024-and-msrv-bump.md) · L · setup — after T93
...
Total: 80 M0–M4 tickets (all merged), plus 7 M5 tickets (**T71–T77**, docs 083–091) and 4 M6 tickets (**T78–T81**, docs 093–096), plus 7 M7 tickets (**T82–T88**, docs 097–103), 3 M8 tickets (**T89–T91**, docs 104–106), and 8 M9 tickets (**T92–T99**, docs 107–114). The M5 ADRs (082, 086, 089) and the M6 ADR (092) are decision records like ADR 081 and are not counted as tickets; M7's ADR (097 · **T82**) is instead a decision **ticket** — it amends arch.md's permanent boundary and needs operator sign-off, so it ships through the normal branch/PR flow. M9's opening ticket (107 · **T92**) is likewise a decision ticket: it records the disposition of every rule and the reasoning behind each non-adoption. `T0.1` (the spec-amendment pass) is already done and has no ticket.
